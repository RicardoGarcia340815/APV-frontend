...
const Registrar = () => {
 ...
 const [nombre, setNombre] = useState("");//Empieza con un string vacio
 ...
 const [alerta, setAlerta] = useState("");
  ...
  const handleSubmit = async(e) =>{
    ...
    try {
     ...
     setAlerta({
        msg: error.response.data.msg, //Proviene del backend
        error: true
      })
    }
 ...
 return (
    <>
      ...
      <div className="mt-20 md:mt-5 shadow-lg px-5 py-10 rounded-xl bg-white">
        ...
        {/* Generar mensaje de alerta, este se encuentra en los components*/}
        {/* Si en mensaje hay algo muestra el componente Alertaalerta */}
        {msg && <Alerta 
        alerta={alerta}
        />
        }
        <form action="" onSubmit={handleSubmit}>
          ...
          <input type="submit" value="Crear Cuenta" className="bg-indigo-700 w-full py-3 px-10 rounded-xl text-white uppercase font-bold mt-5 hover:cursor-pointer hover:bg-gray-300 hover:text-indigo-700 md:w-auto"/>
